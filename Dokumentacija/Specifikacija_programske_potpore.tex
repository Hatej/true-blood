...
\noindent \underbar{\textbf{UC$11$ -{Aktiviraj račun}}}
\begin{packed_item}
...
\end{packed_item}
\eject
\noindent \underbar{\textbf{UC$12$ -{Evidentiraj pokušaj doniranja}	}}
\begin{packed_item}
...
\end{packed_item}
\eject 
\noindent \underbar{\textbf{UC$13$ -{Obriši donora}	}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$14$ -{Definiraj optimalne granice}	}}
\begin{packed_item}
...
\end{packed_item}
\eject
\noindent \underbar{\textbf{UC$15$ -{Pregledaj popis djelatnika}	}}
\begin{packed_item}
...
\noindent \underbar{\textbf{UC$16$ -{Obriši djelatnika banke}}}
\begin{packed_item}
	\item \textbf{Glavni sudionik: }{Administrator}
...
\noindent \underbar{\textbf{UC$17$ -{Kreiraj kor. računa djelatnika banke}	}}
\begin{packed_item}
...
\end{packed_item}
\eject 
\noindent \underbar{\textbf{UC$18$ -{Pošalji notifikacije nakon 3/4 mjeseca}	}}
\begin{packed_item}

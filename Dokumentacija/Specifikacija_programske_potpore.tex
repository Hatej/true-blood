...
\begin{packed_item}
	...
	\item[] \begin{packed_enum}
		...
		\item {Sustav svima koji zadovoljavaju uvjet šalje email notifikacije da mogu doći ponovno donirati krv}
		\item {Sustav svima koji zadovoljavaju uvjet šalje poruke u njihov pretinac poruka da mogu doći ponovno donirati krv}

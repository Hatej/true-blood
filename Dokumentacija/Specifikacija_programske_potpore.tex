...
\noindent \underbar{\textbf{UC$17$ -\textit{Kreiranje kor. računa djelatnika banke}	}}
\begin{packed_item}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth, scale=0.4]{slike/UC9_Evidentiranje_potrošnje_ krvi.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{slike/UC12_Evidentiranje pokušaja doniranja.png}

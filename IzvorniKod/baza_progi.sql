...
CREATE TABLE "pokusajDoniranja" (
  ...
  "uspjesnost" boolean NOT NULL,
  "korisnikIdDjelatnika" INT NOT NULL,
  "korisnikId" INT NOT NULL,
  "uspjesh" boolean NOT NULL,
  "razlogObijanja" VARCHAR
);
...
ALTER TABLE "aktivacijski_kodovi" ADD FOREIGN KEY ("korisnikId") REFERENCES "korisnikAplikacije" ("korisnikId");

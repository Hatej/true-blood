...
public class SeleniumTests {
	...
	private static boolean sendBlood(WebDriver driver, int bloodIndex) {
      ...
      //submit (login)
        ...
        Select dropdown = new Select(driver.findElement(By.cssSelector("#left-tabs-example-tabpane-third > div > div > div.container.col-md-3.border.border-danger.rounded > form > div:nth-child(1) > div > select")));
	...
	public static boolean makeDonation(WebDriver driver) {
      ...
      //submit (login)
        ...
        return alertText.equals("Donacija evidentirana");
